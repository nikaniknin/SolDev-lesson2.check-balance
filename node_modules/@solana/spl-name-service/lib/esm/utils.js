...
export async function getHashedName(name) {
    const input = HASH_PREFIX + name;
    const buffer = createHash('sha256').update(input, 'utf8').digest();
    return buffer;
}
export async function getNameAccountKey(hashed_name, nameClass, nameParent) {
...
export async function getNameOwner(connection, nameAccountKey) {
