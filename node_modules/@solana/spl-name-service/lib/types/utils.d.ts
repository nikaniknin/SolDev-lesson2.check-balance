...
import { AccountInfo, Connection, GetProgramAccountsFilter, Keypair, PublicKey, TransactionInstruction } from '@solana/web3.js';
...
export declare function getFilteredProgramAccounts(connection: Connection, programId: PublicKey, filters: GetProgramAccountsFilter[]): Promise<{
    publicKey: PublicKey;
