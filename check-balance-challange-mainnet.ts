...
//for invalid PK run: npx esrun check-balance-challange BDeHQNAw7R88j6mZLFc8CgQ4FoFN3AoDiM83CYSFV
//run for toly.sol: npx esrun check-balance-challange-mainnet CU4qeGHCTgxVymgtfrYSuPPcpsxbffyuGJLLxHiy9RyH 
