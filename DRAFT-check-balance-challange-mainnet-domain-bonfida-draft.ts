...
//3const domainName = "bonfida"; // With or without the .sol at the end
const domainName = process.argv[2]; //"bonfida"; // With or without the .sol at the end
if (!domainName) {
...
//npx esrun check-balance-challange-mainnet-domain-bon